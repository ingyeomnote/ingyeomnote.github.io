...
- `<tagname>`을 시작 태그, `</tagname>`을 종료 태그라고 한다.
...
<img src="https://user-images.githubusercontent.com/79016263/111899732-ab9c0b00-8a71-11eb-801e-04be159327f2.png" alt="블록과 인라인요소" align="center" />
...
<img src="https://user-images.githubusercontent.com/79016263/111899809-13525600-8a72-11eb-9be0-ca802700dc74.png" alt="blockquote" align="center" />
...
<img src="https://user-images.githubusercontent.com/79016263/111899724-aa6ade00-8a71-11eb-9d63-92b1ec51fd21.png" alt="image-link" align="center" />
...
링크의 기본 문법은  `<a href="xxx">Label</a>` 이와 같은 형태로 이루어진다. 이는 "xxx"로 지정한 웹페이지, 이미지, 파일 등의 대상을 처리하는 코드인데 onclick 이벤트와 비슷하게 해당 영역을 클릭해야 event를 실행한다. 기본 문법에서는 text 형태로 'Label'  문자열을 입력했기 때문에 Label의 text length만큼 영역이 정해지지만, 위의 소스 코드에서는,

`<img alt="링크" src="resources/image/teri.png" width="100px" height="100px"/>` 

img 태그를 사용하여 width=100px이고, height=100px인 이미지 영역을 잡아놨기 때문에 해당 영역을 누르게 되면 index.html 파일로 이동하게 된다.
...
<body>
	...
	<a href = "http://www.naver.com">naver</a><br/> <!-- a -->
...
a번째 라인 클릭시  https://www.naver.com으로 이동

b번째 라인 클릭시 id가 a인 태크로 이동 `<p id = "a">1번`

c번째 라인 클릭시 id가 b인 태크로 이동 `<p id = "b">1번`

d번째 라인 클릭시 id가 c인 태크로 이동 `<p id = "c">1번`   
...
<img src="https://user-images.githubusercontent.com/79016263/111899726-ab037480-8a71-11eb-9476-4b4c09fd0e9b.png" alt="순차적목록" align = "center"/>  
...
<img src="https://user-images.githubusercontent.com/79016263/111899728-ab037480-8a71-11eb-850f-5b7ae4312da4.png" alt="비순차적목록" align ="center" />  
...
<img src="https://user-images.githubusercontent.com/79016263/111899730-ab9c0b00-8a71-11eb-9547-caa19c632bde.png" alt="정의형목록" align = "center" />  
...
<img src="https://user-images.githubusercontent.com/79016263/111899733-accd3800-8a71-11eb-8620-7c4d117fe0ca.png" alt="컬럼테이블" align="center" />  
...
<img src="https://user-images.githubusercontent.com/79016263/111899731-ab9c0b00-8a71-11eb-9936-e7fcd801432b.png" alt="컬럼테이블" align="center" />  
